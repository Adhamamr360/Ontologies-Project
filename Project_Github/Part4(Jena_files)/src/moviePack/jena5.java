...
public class jena5 {
    public static void main(String[] args) {
        ...
        String queryFile = "Data/movieRules.txt";
        ...
        resultModel.listObjectsOfProperty(resultModel.createProperty("http://www.semanticweb.org/mariam/ontologies/2024/3/movie#name"))
