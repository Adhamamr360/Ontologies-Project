...
//        String movieTitle = "Joker";
        ...
        OntClass movieClass = model.getOntClass("http://www.semanticweb.org/mariam/ontologies/2024/3/movie#Movie");
        ...
        while (movieIterator.hasNext()) {
            ...
            Property titleProperty = model.getProperty("http://www.semanticweb.org/mariam/ontologies/2024/3/movie#title");
        ...
        if (targetMovie == null) {
            ...
            Property yearProperty = model.getProperty("http://www.semanticweb.org/mariam/ontologies/2024/3/movie#year");
            ...
            // Display the Country
            Property countryProperty = model.getProperty("http://www.semanticweb.org/mariam/ontologies/2024/3/movie#country");
            ...
            // Display the Genre
            Property genreProperty = model.getProperty("http://www.semanticweb.org/mariam/ontologies/2024/3/movie#HasGenre");
            ...
            while (genreIterator.hasNext()) {
                ...
                if (genreNode != null && genreNode.isResource()) {
                    ...
                    Property genreNameProperty = model.getProperty("http://www.semanticweb.org/mariam/ontologies/2024/3/movie#genre");
            ...
            // Display the Actor
            Property actorProperty = model.getProperty("http://www.semanticweb.org/mariam/ontologies/2024/3/movie#HasActor");
            ...
            Property directorProperty = model.getProperty("http://www.semanticweb.org/mariam/ontologies/2024/3/movie#HasDirector");
            ...
            // Display the Writer
            Property writerProperty = model.getProperty("http://www.semanticweb.org/mariam/ontologies/2024/3/movie#HasWriter");
